...
import NotFound from "rs-common/components/not-found";
...
<template><div class="error-display" ...attributes>
  <div class="error-main">
    ...
    {{else}}
      ...
      <p class="clear-errors">
        ...
        <button type="button" class="error-detail-action" {{on "click" (set this "showDetails" (not this.showDetails))}}>
      ...
      {{#if this.showDetails}}
        <div class="timestamp">
          {{formatTime this.now year="numeric" month="numeric" day="numeric" hour="numeric" second="numeric" minute="numeric" timeZoneName="short"}}
        </div>
